...
public partial class Contract
{
  ...
  private Contract Validate<T>(T[] list, int comparer, string property, string message, Func<T[], int, bool> condition) where T : IConvertible 
  {
  ...
  /// <param name="condition">Condição a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  private Contract ValidateList<T>(T[] list, T[] comparer, string property, string message, Func<T[], T[], bool> condition) where T : IConvertible
  {
    // Se a condição for verdadeira, adicione a notificação.
    if (condition(list, comparer))
    {
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsGreater<T>(T[] list, int comparer, string property) where T : IConvertible =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsGreater<T>(T[] list, int comparer, string property, string message) where T : IConvertible =>
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsGreaterOrEquals<T>(T[] list, int comparer, string property) where T : IConvertible =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsGreaterOrEquals<T>(T[] list, int comparer, string property, string message) where T : IConvertible =>
    Validate(list, comparer, property, message, (v, c) => v.Length < c);
  #endregion
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsLower<T>(T[] list, int comparer, string property) where T : IConvertible =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsLower<T>(T[] list, int comparer, string property, string message) where T : IConvertible =>
    Validate(list, comparer, property, message, (v, c) => v.Length >= c);
  #endregion
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsLowerOrEquals<T>(T[] list, int comparer, string property) where T : IConvertible =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsLowerOrEquals<T>(T[] list, int comparer, string property, string message) where T : IConvertible =>
    Validate(list, comparer, property, message, (v, c) => v.Length > c);
  #endregion
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract AreEquals<T>(T[] list, T[] comparer, string property) where T : IConvertible =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract AreEquals<T>(T[] list, T[] comparer, string property, string message) where T : IConvertible =>
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract AreNotEquals<T>(T[] list, T[] comparer, string property) where T : IConvertible =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract AreNotEquals<T>(T[] list, T[] comparer, string property, string message) where T : IConvertible =>
    ValidateList(list, comparer, property, message, (v, c) => v.Equals(c));
  #endregion
  ...
  public Contract IsNull<T>(T[]? list, string property) =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato.</returns>
  public Contract IsNull<T>(T[]? list, string property, string message)
  {
    // Se a condição for verdadeira, adicione a notificação.
    if (list != null)
    {
  ...
  /// <param name="property">Nome da propriedade.</param>
  /// <returns>Contrato.</returns>
  public Contract IsNotNull<T>(T[]? list, string property) =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato.</returns>
  public Contract IsNotNull<T>(T[]? list, string property, string message)
  {
    // Se a condição for verdadeira, adicione a notificação.
    if (list == null)
    {
  ...
  /// <param name="property">Nome da propriedade.</param>
  /// <returns>Contrato.</returns>
  public Contract IsEmpty<T>(T[]? list, string property) =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato.</returns>
  public Contract IsEmpty<T>(T[]? list, string property, string message)
  {
    // Se a condição for verdadeira, adicione a notificação.
    if (list?.Length > 0)
    {
  ...
  /// <param name="property">Nome da propriedade.</param>
  /// <returns>Contrato.</returns>
  public Contract IsNotEmpty<T>(T[]? list, string property) =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato.</returns>
  public Contract IsNotEmpty<T>(T[]? list, string property, string message)
  {
    // Se a condição for verdadeira, adicione a notificação.
    if (list?.Length == 0)
    {
