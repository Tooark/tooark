...
public partial class Contract
{
  ...
  private Contract Validate(double value, double comparer, string property, string message, Func<double, double, bool> condition)
  {
  ...
  /// <param name="condition">Condição a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  private Contract Validate<T>(double value, T comparer, string property, string message, Func<double, double, bool> condition) where T : IConvertible =>
  ...
  /// <param name="condition">Condição a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  private Contract ValidateList(double value, double[] list, string property, string message, Func<double, double[], bool> condition)
  {
    // Se a condição for verdadeira, adicione a notificação.
  ...
  /// <param name="condition">Condição a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  private Contract ValidateList<T>(double value, T[] list, string property, string message, Func<double, double[], bool> condition) where T : IConvertible =>
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsGreater<T>(double value, T comparer, string property) where T : IConvertible =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsGreater<T>(double value, T comparer, string property, string message) where T : IConvertible =>
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsGreaterOrEquals<T>(double value, T comparer, string property) where T : IConvertible =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsGreaterOrEquals<T>(double value, T comparer, string property, string message) where T : IConvertible =>
    Validate(value, comparer, property, message, (v, c) => v < c);
  #endregion
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsLower<T>(double value, T comparer, string property) where T : IConvertible =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsLower<T>(double value, T comparer, string property, string message) where T : IConvertible =>
    Validate(value, comparer, property, message, (v, c) => v >= c);
  #endregion
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsLowerOrEquals<T>(double value, T comparer, string property) where T : IConvertible =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsLowerOrEquals<T>(double value, T comparer, string property, string message) where T : IConvertible =>
    Validate(value, comparer, property, message, (v, c) => v > c);
  #endregion
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsBetween<T>(double value, T start, T end, string property) where T : IConvertible =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsBetween<T>(double value, T start, T end, string property, string message) where T : IConvertible =>
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsNotBetween<T>(double value, T start, T end, string property) where T : IConvertible =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsNotBetween<T>(double value, T start, T end, string property, string message) where T : IConvertible =>
    Validate(value, start, property, message, (v, s) => v >= s && v <= ConvertToDouble(end));
  #endregion
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract AreEquals<T>(double value, T comparer, string property) where T : IConvertible =>
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract AreNotEquals<T>(double value, T comparer, string property) where T : IConvertible =>
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract Contains<T>(double value, T[] list, string property) where T : IConvertible =>
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract NotContains<T>(double value, T[] list, string property) where T : IConvertible =>
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract All<T>(double value, T[] list, string property) where T : IConvertible =>
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract NotAll<T>(double value, T[] list, string property) where T : IConvertible =>
  ...
  public Contract IsNull(double? value, string property) =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato.</returns>
  public Contract IsNull(double? value, string property, string message) =>
  ...
  /// <param name="property">Nome da propriedade.</param>
  /// <returns>Contrato.</returns>
  public Contract IsNotNull(double? value, string property) =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato.</returns>
  public Contract IsNotNull(double? value, string property, string message) =>
