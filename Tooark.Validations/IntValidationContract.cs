...
public partial class Contract
{
  ...
  private Contract Validate(int value, int comparer, string property, string message, Func<int, int, bool> condition)
  {
  ...
  /// <param name="condition">Condição a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  private Contract Validate<T>(int value, T comparer, string property, string message, Func<int, int, bool> condition) where T : IConvertible =>
  ...
  /// <param name="condition">Condição a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  private Contract ValidateList(int value, int[] list, string property, string message, Func<int, int[], bool> condition)
  {
    // Se a condição for verdadeira, adicione a notificação.
  ...
  /// <param name="condition">Condição a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  private Contract ValidateList<T>(int value, T[] list, string property, string message, Func<int, int[], bool> condition) where T : IConvertible =>
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsGreater<T>(int value, T comparer, string property) where T : IConvertible =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsGreater<T>(int value, T comparer, string property, string message) where T : IConvertible =>
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsGreaterOrEquals<T>(int value, T comparer, string property) where T : IConvertible =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsGreaterOrEquals<T>(int value, T comparer, string property, string message) where T : IConvertible =>
    Validate(value, comparer, property, message, (v, c) => v < c);
  #endregion
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsLower<T>(int value, T comparer, string property) where T : IConvertible =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsLower<T>(int value, T comparer, string property, string message) where T : IConvertible =>
    Validate(value, comparer, property, message, (v, c) => v >= c);
  #endregion
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsLowerOrEquals<T>(int value, T comparer, string property) where T : IConvertible =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsLowerOrEquals<T>(int value, T comparer, string property, string message) where T : IConvertible =>
    Validate(value, comparer, property, message, (v, c) => v > c);
  #endregion
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsBetween<T>(int value, T start, T end, string property) where T : IConvertible =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsBetween<T>(int value, T start, T end, string property, string message) where T : IConvertible =>
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsNotBetween<T>(int value, T start, T end, string property) where T : IConvertible =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsNotBetween<T>(int value, T start, T end, string property, string message) where T : IConvertible =>
    Validate(value, start, property, message, (v, s) => v >= s && v <= ConvertToInt(end));
  #endregion
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsMin(int value, string property) =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsMin(int value, string property, string message) =>
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsNotMin(int value, string property) =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsNotMin(int value, string property, string message) =>
    Validate(value, int.MinValue, property, message, (v, c) => v == c);
  #endregion
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsMax(int value, string property) =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsMax(int value, string property, string message) =>
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsNotMax(int value, string property) =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract IsNotMax(int value, string property, string message) =>
    Validate(value, int.MaxValue, property, message, (v, c) => v == c);
  #endregion
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract AreEquals<T>(int value, T comparer, string property) where T : IConvertible =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract AreEquals<T>(int value, T comparer, string property, string message) where T : IConvertible =>
    Validate(value, comparer, property, message, (v, c) => v != c);
  #endregion
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract AreNotEquals<T>(int value, T comparer, string property) where T : IConvertible =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract AreNotEquals<T>(int value, T comparer, string property, string message) where T : IConvertible =>
    Validate(value, comparer, property, message, (v, c) => v == c);
  #endregion
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract Contains<T>(int value, T[] list, string property) where T : IConvertible =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract Contains<T>(int value, T[] list, string property, string message) where T : IConvertible =>
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract NotContains<T>(int value, T[] list, string property) where T : IConvertible =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract NotContains<T>(int value, T[] list, string property, string message) where T : IConvertible =>
    ValidateList(value, list, property, message, (v, l) => l.Contains(v));
  #endregion
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract All<T>(int value, T[] list, string property) where T : IConvertible =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract All<T>(int value, T[] list, string property, string message) where T : IConvertible =>
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract NotAll<T>(int value, T[] list, string property) where T : IConvertible =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract NotAll<T>(int value, T[] list, string property, string message) where T : IConvertible =>
    ValidateList(value, list, property, message, (v, l) => l.All(x => x == v));
  #endregion
  ...
  public Contract IsNull(int? value, string property) =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato.</returns>
  public Contract IsNull(int? value, string property, string message) =>
  ...
  /// <param name="property">Nome da propriedade.</param>
  /// <returns>Contrato.</returns>
  public Contract IsNotNull(int? value, string property) =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato.</returns>
  public Contract IsNotNull(int? value, string property, string message) =>
