...
public partial class Contract
{
  ...
  private Contract Validate(Guid value, Guid comparer, string property, string message, Func<Guid, Guid, bool> condition)
  {
  ...
  /// <param name="condition">Condição a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  private Contract ValidateList(Guid value, Guid[] list, string property, string message, Func<Guid, Guid[], bool> condition)
  {
    // Se a condição for verdadeira, adicione a notificação.
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract AreEquals(Guid value, Guid comparer, string property) =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract AreEquals(Guid value, Guid comparer, string property, string message) =>
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract AreNotEquals(Guid value, Guid comparer, string property) =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract AreNotEquals(Guid value, Guid comparer, string property, string message) =>
    Validate(value, comparer, property, message, (v, c) => v == c);
  #endregion
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract Contains(Guid value, Guid[] list, string property) =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract Contains(Guid value, Guid[] list, string property, string message) =>
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract NotContains(Guid value, Guid[] list, string property) =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract NotContains(Guid value, Guid[] list, string property, string message) =>
    ValidateList(value, list, property, message, (v, l) => l.Contains(v));
  #endregion
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract All(Guid value, Guid[] list, string property) =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract All(Guid value, Guid[] list, string property, string message) =>
  ...
  /// <param name="property">Propriedade a ser validada.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract NotAll(Guid value, Guid[] list, string property) =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato de validação.</returns>
  public Contract NotAll(Guid value, Guid[] list, string property, string message) =>
    ValidateList(value, list, property, message, (v, l) => l.All(x => x == v));
  #endregion
  ...
  public Contract IsNull(Guid? value, string property) =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato.</returns>
  public Contract IsNull(Guid? value, string property, string message) =>
  ...
  /// <param name="property">Nome da propriedade.</param>
  /// <returns>Contrato.</returns>
  public Contract IsNotNull(Guid? value, string property) =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato.</returns>
  public Contract IsNotNull(Guid? value, string property, string message) =>
  ...
  /// <param name="property">Nome da propriedade.</param>
  /// <returns>Contrato.</returns>
  public Contract IsEmpty(Guid? value, string property) =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato.</returns>
  public Contract IsEmpty(Guid? value, string property, string message)
  {
    // Se a condição for verdadeira, adicione a notificação.
    if (value != Guid.Empty)
    {
  ...
  /// <param name="property">Nome da propriedade.</param>
  /// <returns>Contrato.</returns>
  public Contract IsNotEmpty(Guid? value, string property) =>
  ...
  /// <param name="message">Mensagem de erro.</param>
  /// <returns>Contrato.</returns>
  public Contract IsNotEmpty(Guid? value, string property, string message)
  {
    // Se a condição for verdadeira, adicione a notificação.
    if (value == Guid.Empty)
    {
