...
public class DoubleValidationTests
{
  ...
  [InlineData(0, 0)]
  [InlineData(0, 1)]
  public void IsGreater_ShouldAddNotification_WhenValueIsNotGreater(double valueParam, double comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
    double value = valueParam;
  ...
  [InlineData(0, -2)]
  [InlineData(0, -1)]
  public void IsGreater_ShouldNotAddNotification_WhenValueIsGreater(double valueParam, double comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, 1)]
  [InlineData(0, 2)]
  public void IsGreaterOrEquals_ShouldAddNotification_WhenValueIsNotGreaterOrEquals(double valueParam, double comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, -1)]
  [InlineData(0, 0)]
  public void IsGreaterOrEquals_ShouldNotAddNotification_WhenValueIsGreaterOrEquals(double valueParam, double comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, 0)]
  [InlineData(0, -1)]
  public void IsLower_ShouldAddNotification_WhenValueIsNotGreater(double valueParam, double comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, 2)]
  [InlineData(0, 1)]
  public void IsLower_ShouldNotAddNotification_WhenValueIsLower(double valueParam, double comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, -2)]
  [InlineData(0, -1)]
  public void IsLowerOrEquals_ShouldAddNotification_WhenValueIsNotLowerOrEquals(double valueParam, double comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, 0)]
  [InlineData(0, 1)]
  public void IsLowerOrEquals_ShouldNotAddNotification_WhenValueIsLowerOrEquals(double valueParam, double comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(-3, -1, 1)]
  [InlineData(3, -2, 2)]
  public void IsBetween_ShouldAddNotification_WhenValueIsNotBetweenStartAndEnd(double valueParam, double start, double end)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, -1, 1)]
  [InlineData(0, -2, 2)]
  public void IsBetween_ShouldNotAddNotification_WhenValueIsBetweenStartAndEnd(double valueParam, double start, double end)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, -1, 1)]
  [InlineData(0, -2, 2)]
  public void IsNotBetween_ShouldAddNotification_WhenValueIsBetweenStartAndEnd(double valueParam, double start, double end)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(-3, -1, 1)]
  [InlineData(3, -2, 2)]
  public void IsNotBetween_ShouldNotAddNotification_WhenValueIsNotBetweenStartAndEnd(double valueParam, double start, double end)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
