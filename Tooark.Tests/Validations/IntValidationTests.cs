...
public class IntValidationTests
{
  ...
  [InlineData(0, 0)]
  [InlineData(0, 1)]
  public void IsGreater_ShouldAddNotification_WhenValueIsNotGreater(int valueParam, int comparer)
  {
    // Arrange
  ...
  [InlineData(0, -2)]
  [InlineData(0, -1)]
  public void IsGreater_ShouldNotAddNotification_WhenValueIsGreater(int valueParam, int comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, 1)]
  [InlineData(0, 2)]
  public void IsGreaterOrEquals_ShouldAddNotification_WhenValueIsNotGreaterOrEquals(int valueParam, int comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, -1)]
  [InlineData(0, 0)]
  public void IsGreaterOrEquals_ShouldNotAddNotification_WhenValueIsGreaterOrEquals(int valueParam, int comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, 0)]
  [InlineData(0, -1)]
  public void IsLower_ShouldAddNotification_WhenValueIsNotGreater(int valueParam, int comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, 2)]
  [InlineData(0, 1)]
  public void IsLower_ShouldNotAddNotification_WhenValueIsLower(int valueParam, int comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, -2)]
  [InlineData(0, -1)]
  public void IsLowerOrEquals_ShouldAddNotification_WhenValueIsNotLowerOrEquals(int valueParam, int comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, 0)]
  [InlineData(0, 1)]
  public void IsLowerOrEquals_ShouldNotAddNotification_WhenValueIsLowerOrEquals(int valueParam, int comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(-3, -1, 1)]
  [InlineData(3, -2, 2)]
  public void IsBetween_ShouldAddNotification_WhenValueIsNotBetweenStartAndEnd(int valueParam, int start, int end)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, -1, 1)]
  [InlineData(0, -2, 2)]
  public void IsBetween_ShouldNotAddNotification_WhenValueIsBetweenStartAndEnd(int valueParam, int start, int end)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, -1, 1)]
  [InlineData(0, -2, 2)]
  public void IsNotBetween_ShouldAddNotification_WhenValueIsBetweenStartAndEnd(int valueParam, int start, int end)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(-3, -1, 1)]
  [InlineData(3, -2, 2)]
  public void IsNotBetween_ShouldNotAddNotification_WhenValueIsNotBetweenStartAndEnd(int valueParam, int start, int end)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
