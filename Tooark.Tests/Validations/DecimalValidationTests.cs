...
public class DecimalValidationTests
{
  ...
  [InlineData(0, 0)]
  [InlineData(0, 1)]
  public void IsGreater_ShouldAddNotification_WhenValueIsNotGreater(decimal valueParam, decimal comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
    decimal value = valueParam;
    ...
    // Assert
    Assert.Equal(5, validation.Notifications.Count);
  ...
  [InlineData(0, -2)]
  [InlineData(0, -1)]
  public void IsGreater_ShouldNotAddNotification_WhenValueIsGreater(decimal valueParam, decimal comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, 1)]
  [InlineData(0, 2)]
  public void IsGreaterOrEquals_ShouldAddNotification_WhenValueIsNotGreaterOrEquals(decimal valueParam, decimal comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, -1)]
  [InlineData(0, 0)]
  public void IsGreaterOrEquals_ShouldNotAddNotification_WhenValueIsGreaterOrEquals(decimal valueParam, decimal comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, 0)]
  [InlineData(0, -1)]
  public void IsLower_ShouldAddNotification_WhenValueIsNotGreater(decimal valueParam, decimal comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, 2)]
  [InlineData(0, 1)]
  public void IsLower_ShouldNotAddNotification_WhenValueIsLower(decimal valueParam, decimal comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, -2)]
  [InlineData(0, -1)]
  public void IsLowerOrEquals_ShouldAddNotification_WhenValueIsNotLowerOrEquals(decimal valueParam, decimal comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, 0)]
  [InlineData(0, 1)]
  public void IsLowerOrEquals_ShouldNotAddNotification_WhenValueIsLowerOrEquals(decimal valueParam, decimal comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(-3, -1, 1)]
  [InlineData(3, -2, 2)]
  public void IsBetween_ShouldAddNotification_WhenValueIsNotBetweenStartAndEnd(decimal valueParam, decimal start, decimal end)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, -1, 1)]
  [InlineData(0, -2, 2)]
  public void IsBetween_ShouldNotAddNotification_WhenValueIsBetweenStartAndEnd(decimal valueParam, decimal start, decimal end)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, -1, 1)]
  [InlineData(0, -2, 2)]
  public void IsNotBetween_ShouldAddNotification_WhenValueIsBetweenStartAndEnd(decimal valueParam, decimal start, decimal end)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(-3, -1, 1)]
  [InlineData(3, -2, 2)]
  public void IsNotBetween_ShouldNotAddNotification_WhenValueIsNotBetweenStartAndEnd(decimal valueParam, decimal start, decimal end)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
