...
public class LongValidationTests
{
  ...
  [InlineData(0, 0)]
  [InlineData(0, 1)]
  public void IsGreater_ShouldAddNotification_WhenValueIsNotGreater(long valueParam, long comparer)
  {
    // Arrange
  ...
  [InlineData(0, -2)]
  [InlineData(0, -1)]
  public void IsGreater_ShouldNotAddNotification_WhenValueIsGreater(long valueParam, long comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, 1)]
  [InlineData(0, 2)]
  public void IsGreaterOrEquals_ShouldAddNotification_WhenValueIsNotGreaterOrEquals(long valueParam, long comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, -1)]
  [InlineData(0, 0)]
  public void IsGreaterOrEquals_ShouldNotAddNotification_WhenValueIsGreaterOrEquals(long valueParam, long comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, 0)]
  [InlineData(0, -1)]
  public void IsLower_ShouldAddNotification_WhenValueIsNotGreater(long valueParam, long comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, 2)]
  [InlineData(0, 1)]
  public void IsLower_ShouldNotAddNotification_WhenValueIsLower(long valueParam, long comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, -2)]
  [InlineData(0, -1)]
  public void IsLowerOrEquals_ShouldAddNotification_WhenValueIsNotLowerOrEquals(long valueParam, long comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, 0)]
  [InlineData(0, 1)]
  public void IsLowerOrEquals_ShouldNotAddNotification_WhenValueIsLowerOrEquals(long valueParam, long comparer)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(-3, -1, 1)]
  [InlineData(3, -2, 2)]
  public void IsBetween_ShouldAddNotification_WhenValueIsNotBetweenStartAndEnd(long valueParam, long start, long end)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, -1, 1)]
  [InlineData(0, -2, 2)]
  public void IsBetween_ShouldNotAddNotification_WhenValueIsBetweenStartAndEnd(long valueParam, long start, long end)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(0, -1, 1)]
  [InlineData(0, -2, 2)]
  public void IsNotBetween_ShouldAddNotification_WhenValueIsBetweenStartAndEnd(long valueParam, long start, long end)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
  ...
  [InlineData(-3, -1, 1)]
  [InlineData(3, -2, 2)]
  public void IsNotBetween_ShouldNotAddNotification_WhenValueIsNotBetweenStartAndEnd(long valueParam, long start, long end)
  {
    // Arrange
    var property = "TestProperty";
    var validation = new Validation();
